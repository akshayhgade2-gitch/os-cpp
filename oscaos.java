...
public class oscaos
{
    ...
    public static void main(String[] args)throws IOException 
    {
     ...
     //char b1,b2,b3,b4;
     String str,reg1="";
     String datacoll[]=new String[100];
     int gdblk=0,jbid=0,jbin=0,jbpd=0,togreg=0;
     File f1=new File("D:/VIT/sy/caos_project/New folder/temp.txt");
     FileWriter f2=new FileWriter("D:/VIT/sy/caos_project/New folder/output.txt");
     ...
     while(sc.hasNextLine())
     {
        ...
        {System.out.println("inside data");
            int i=0;
            for(int j=0;j<jbpd;j++)
            {
                System.out.println("inseid data while 1");
                str=sc.nextLine();
                datacoll[i]=str;System.out.println(datacoll[i]);
                i++;System.out.println("inseid data while 2");
            }
        }

        else if(str.substring(0,5).equals("$ENDJ"))
        {System.out.println("inside else endj");
            String inst="";
            ...
            {*/int i=0,datact=0;
                ...
                if(inst.substring(0,2).equals("GD"))
                {
                    gdblk=Integer.parseInt(inst.substring(2,4));
                    int j=gdblk,ct=0;
                    try {while(j<gdblk+10)
                        {int k=0;
                        while(k<=3)
                                {System.out.println("ct"+ct);
                                ar[j][k]=datacoll[datact].charAt(ct);
                                    System.out.print(j+" ");
                                    System.out.print(k+" ");
                                    System.out.println(ar[j][k]);
                                    k++;ct++;System.out.println("k");
                ...
                else if(inst.substring(0,2).equals("PD"))
